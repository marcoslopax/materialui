        ...
        <CardContent sx={{
          ...
          <Grid item xs={12}>  
            <FormControl fullWidth>
              ...
              <FormHelperText id="tarefa_descricao_helper_text">Descreva a Tarefa</FormHelperText>
            </FormControl>
          </Grid>
          <Grid container spacing={2} mt={1}>
            <Grid item xs={3}>  
              <FormControl>
                ...
                />
                <FormHelperText id="tarefa_inicio_helper_text">Data Início</FormHelperText>
              </FormControl>
            </Grid>  
            <Grid item xs={3}>  
              <FormControl>
                ...
                />
                <FormHelperText id="tarefa_fim_helper_text">Data Fim</FormHelperText>
              </FormControl>
            </Grid>
            <Grid item xs={3}>  
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value={'Recurso 1'}>Operacional</MenuItem>
                  <MenuItem value={'Recurso 2'}>Técnico</MenuItem>
                  <MenuItem value={'Recurso 3'}>Financeiro</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid item xs={3}>  
